...
export default function MobileMenu() {
  ...
  return (
    <div class='md:hidden relative z-50'>
      {/* Botón abrir */}
      <button aria-label='Abrir menú' onClick={() => setIsOpen(true)} class=''>
      ...
      {isOpen && (
        <div class='fixed h-screen inset-0 bg-black/90 backdrop-blur-sm flex flex-col justify-center items-center gap-6 text-xl  z-50 animate-fade-in'>
          {/* Links */}
          <a href='#About' class='text_glowing' onClick={() => setIsOpen(false)}>
            Sobre nosotros
          </a>
          <a href='#Service' class='text_glowing' onClick={() => setIsOpen(false)}>
            Servicios
          </a>
          <a href='#Location' class='text_glowing' onClick={() => setIsOpen(false)}>
            Ubicación
          </a>
          <a href='#Contact' class='text_glowing' onClick={() => setIsOpen(false)}>
            Contáctanos
          </a>
